...
let books = [
  ...
  { name: 'Book 5', genre: 'Sci-Fi', id: '5', authorId: '1' },
  { name: 'Book 6', genre: 'Action', id: '6', authorId: '2' }
];

let authors = [
  { name: 'Author 1', age: 52, id: '1' },
  { name: 'Author 2', age: 11, id: '2' },
  { name: 'Author 3', age: 88, id: '3' }
];
